import sys
sys.dont_write_bytecode = True  # 添加在文件最开头
...
async def generate_video(request: dict):
    ...
    try:
        ...
        static_preview_path = os.path.join(PREVIEWS_DIR, preview_filename)
        ...
        preview_path = f"/output/previews/{preview_filename}"
...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=17778) 
